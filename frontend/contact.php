...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        echo "<div class='alert alert-danger text-center'>Invalid email address. Please try again.</div>";
    } else {
        // Email headers
        $to = "akshaykumars9108@gmail.com";
        ...
        if (mail($to, $subject, $message, $headers)) {
            ...
            echo "<div class='alert alert-danger text-center'>There was an error sending your message. Please try again later.</div>";
        }
    }
}
?>
